...
//조진석 (MainPage와 상호작용해 클릭된 마커의 충전소 세부정보와 편의시설 개수를 XML에 출력)
//장기윤 : 리스트 구현, MainPage에서 편의시설 목록을 받아와서 리스트에 표시
public class Marker_data extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button write_button = (Button) findViewById(R.id.review_button);
