...
//조진석 : (문화시설 상위 2개 목록 출력 및 총 개수 출력( getAroundCF( ) ), 충전소 정보를 가진 마커 생성 ,
//        MarkerOverlay( ) ), 풍선뷰 클릭 시 이벤트 구현 (onSingleTapUp( ), draw( ), startAnimation( ) ))
//이승형 : 사용자 주변 문화시설 검색 메소드 구현(getAroundCF())
//장기윤 : getAroundCF 코드내 poiString 추가하고 값을 MainPage로 전송
